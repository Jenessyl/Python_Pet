...
<<<<<<< HEAD:src/Laura/-hunger.cpp
  if (feedChoice == "yes") {
    bars.increaseHealthPoints(); // not sure if I need to add the exact amount
                                 // in parameters or not
...
>>>>>>> 564af4488c96ea8487034f619a838d7cd6852ca0:src/Laura/hunger.cpp
}
